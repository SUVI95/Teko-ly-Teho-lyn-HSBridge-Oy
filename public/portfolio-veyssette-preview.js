...
function buildVeyssetteBody(p){
  ...
  h+='<div class="hero-photo"><img src="'+photo+'" alt="'+nm+'"></div></div></section>';
  ...
  if(secV(p,'about')){
    ...
    h+='<div class="about-imgs"><img class="tall" src="'+ABOUT_IMGS[0]+'" alt=""><img src="'+ABOUT_IMGS[1]+'" alt=""></div></div></section>';
  }
  ...
  if(secV(p,'experience')&&ex.length){
    ...
    ex.forEach(function(e,i){
      h+='<article class="exp-card"><img src="'+EXP_IMGS[i%EXP_IMGS.length]+'" alt=""><div class="exp-card-body">';
